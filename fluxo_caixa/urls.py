...
urlpatterns = [
    ...
    path('api/tipos-variacao/<int:pk>/valores/', views.api_tipo_valores, name='api_tipo_valores'),
    path('api/valor-variacao/criar/', views.api_criar_valor, name='api_criar_valor'),
    ...
    path('produto/<int:produto_pk>/tipo-rapido/', views.adicionar_tipo_rapido, name='adicionar_tipo_rapido'),
